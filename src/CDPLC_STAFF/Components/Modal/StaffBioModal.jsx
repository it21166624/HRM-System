...
import { StaffGetEmployeeSummary } from "../../../action/CDPLC_STAFF/StaffAddJob";

export default function StaffBioModal({ open, onClose, value }) {
  ...
  useEffect(() => {
    dispatch(StaffGetEmployeeSummary(value ? value : ""));
  }, []);
        ...
        <React.Fragment>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Typography>
              ...
              <br />
              Other Information : {userData?.UserBioDtails?.other_information}
              <br />
            </Typography>
            <br />
